...
#        },
        ...
        "init_info" : {
            "type" : "stationary",
            "initial_rt_sigma" : (np.eye(7)*0.1).tolist()
        }
    }
...
if __name__ == "__main__":
	...
	manipprob = rave.interfaces.BaseManipulation(robot)
	traj = manipprob.MoveToHandPosition(matrices=[Tgoal],seedik=10,execute=False,outputtrajobj=True)
