...
public:
	...
	// Submatrix
	template <size_t other_numRows, size_t other_numColumns>
	inline Matrix<other_numRows, other_numColumns> subMatrix(size_t row, size_t column) const {
		Matrix<other_numRows, other_numColumns> m;
		for (size_t i = 0; i < other_numRows; ++i) {
			for (size_t j = 0; j < other_numColumns; ++j) {
	...
	// Insert
	template <size_t other_numRows, size_t other_numColumns>
	inline void insert(size_t row, size_t column, const Matrix<other_numRows, other_numColumns>& q) {
		for (size_t i = 0; i < other_numRows; ++i) {
			for (size_t j = 0; j < other_numColumns; ++j) {
	...
	template <size_t other_numColumns>
	inline Matrix<_numRows, other_numColumns> operator*(const Matrix<_numColumns, other_numColumns>& q) const {
		Matrix<_numRows, other_numColumns> m;
